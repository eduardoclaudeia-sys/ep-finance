...
## V1.8 — Benefícios e conciliação bancária por PDF

- Carteiras separadas para Conta/Dinheiro, Vale Alimentação e Vale Refeição.
- VA/VR entram como receitas próprias e despesas descontam somente do respectivo saldo.
- Saldos de VA e VR separados no Dashboard e fora do patrimônio financeiro.
- Importação de extrato bancário em PDF, OFX e CSV.
- Tela de conciliação antes de salvar: escolha individual, data, descrição, tipo, categoria, carteira e valor editáveis.
